...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Swantje\\Desktop\\pilot_contr_inqu\\list2\\pilot2_lastrun.py',
...
intro_block2_2 = visual.TextBox2(
     win, text='Remember: In this part you will read a statement by a speaker, and you will indicate what you expect that speaker to say in the next sentence.\nClick "Continue" to start the experiment.', font='Open Sans',
...
gotValidClick = False  # until a click is received
# keep track of which components have finished
instructions2Components = [logo1_3, introduction_5, continue1_3, mouse_6]
