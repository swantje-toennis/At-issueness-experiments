...
function practice_trial1RoutineBegin(snapshot) {
  return async function () {
    ...
    practice_trial1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_expRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_expComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function practice_trial2RoutineBegin(snapshot) {
  return async function () {
    ...
    practice_trial2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_preferenceRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_preferenceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
