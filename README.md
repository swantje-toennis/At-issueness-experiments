...
The folder [experiments](https://github.com/swantje-toennis/At-issueness-experiments/tree/main/experiments) contains all stimuli and files required to run the main study (in "main") and 4 follow-up pilots (in "pilot") on Pavlovia. All studies were created with the software PsychoPy.

The folder [results](https://github.com/swantje-toennis/At-issueness-experiments/tree/main/results) contains the results (raw data, preprocessed data), figures of the results, and R scripts for cleaning the raw data, creating figures, and (for the main study) analysis.
...
* 4 Stimuli consisting of a context evoking the question addressed by main clause (MC) or by appositive relative clause (ARC) + target sentence with answering evoked question with the MC component or the ARC component.
* Part I: Relative expectectedness was measured for question answered by MC and question answered by ARC, respectively.
* Part II: Continuation rating for target sentence.
* Expectedness ratings for questions as expected.
* No correlation of continuation rating and expectedness was found.
...
* 4 Stimuli consisting of a context evoking the question addressed by main clause (MC) or by appositive relative clause (ARC) + target sentence with answering evoked question with the MC component or the ARC component.
* Part I: Expectectedness was measured for question answered by MC and question answered by ARC, respectively.
* Part II: Prefernece rating between MC addressing evoked Q and ARC addressing evoked Q.
* Expectedness ratings for questions as expected.
* Observed tendency for a preference for sentences where MC answeres (i.e., is at-issue) the more expected Q.
